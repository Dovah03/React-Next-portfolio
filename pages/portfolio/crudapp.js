...
const project = () => (
    <Transition title="CrudApp">
        <Container>
            ...
            <ProjectImage src="/React-Next-portfolio/images/projects/crudapp_1.png" alt="Java Swing Crud App" />
            <ProjectImage src="/React-Next-portfolio/images/projects/crudapp_2.png" alt="Java Swing Crud App" />
        </Container>
    </Transition>
)
