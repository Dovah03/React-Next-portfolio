...
const Page = () => {
  ...
  const onButtonClick = () => {
    ...
    fetch('../public/Mehdi_CV_En.pdf').then(response => {
      ...
      <Container>
        ...
        <Section delay={0.1}>
          ...
          <Paragraph>
            ...
            developing my personal AI Assistant.
          </Paragraph>
          <br/>
        ...
        <Section delay={0.2}>
          ...
          <BioSection>
            ...
            Primarily PEGA AppStudio and PEGA DevStudio
          </BioSection>
          <BioSection>
            <BioYear>2022</BioYear>
          ...
          <BioSection>
            ...
            Developed a Full-Fledged E-commerce website using Angular11 and Node.js.
            </BioSection>
            <BioSection>
            <BioYear>2019</BioYear>
            <strong> O.M.P.I.C : Full Stack Developer (Freelance gig) </strong> -
            Creating and Developing a Java Swing desktop app for the team's internal use cases.
            </BioSection>
            <BioSection>
            <BioYear>2018</BioYear>
            <strong> the Commune of Salé : CMS Wordpress Developer Intern </strong> -
        ...
        <Section delay={0.3}>
          ...
          <Paragraph>I enjoy reading, listening to music and doing camping trips with friends among many other things  </Paragraph>
        </Section>
        <Section delay={0.4}>
          <Heading as="h3" variant="section-title">
          📝 Contact me
          ...
          <List>
            ...
            <ListItem>
              <Link href="https://www.linkedin.com/in/elmehdi-aguendich/" target="_blank">
                <Button
                  variant="ghost"
                  colorScheme="teal"
